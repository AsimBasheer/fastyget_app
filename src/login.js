                            ...
                            fetch(`${BasePath}signin_api.php`, {
                                ...
                                .then((responseJson) => {
                                    ...
                                    if (Flag.flag == 1) {
                                        ...
                                        Toast.show("Signup from facebook before login")
                                        // Toast.show(responseJson.error_msg);
                                        setisLoading(false)
                                        return;
                                    }
                    ...
                    fetch(`${BasePath}signin_api.php`, {
                        ...
                        .then((responseJson) => {
                            ...
                            if (Flag.flag == 1) {
                                ...
                                // Toast.show(Flag.message)
                                Toast.show("Signup from google before login")
                                // Toast.show(responseJson.error_msg);
                                setisLoading(false)
                    ...
                    fetch(`${BasePath}signin_api.php`, {
                        ...
                        .then((responseJson) => {
                            ...
                            if (Flag.flag == 1) {
                                ...
                                // Toast.show(Flag.message)
                                Toast.show("Signup from Apple before login")
                                // Toast.show(responseJson.error_msg);
                                setisLoading(false)
                ...
                <View style={{width:'90%',alignSelf:'center',marginTop:20}} >
                    ...
                    {isLoading?
                        ...
                        <TouchableOpacity onPress={form_validation} style={{height:45,backgroundColor:'#FFBC00',marginTop:20,justifyContent:'center',borderRadius:8}}>
                            <Text style={{fontSize:14,alignSelf:'center',fontWeight:'700'}} >Login</Text>
                        </TouchableOpacity>
                    }
                    ...
                    <TouchableOpacity onPress={()=>props.navigation.navigate('Forgot')} style={{marginTop:15,marginBottom:20}}>
